...
def load_and_preprocess_data(csv_path, use_text=True):
    """
    Load the provided dataset and preprocess for XGBoost.
    """
...
def train_xgboost(X, y):
    """
    Train XGBoost classifier using cross-validation.
    """
    xgb = XGBClassifier(
        n_estimators=100,
        max_depth=6,
...
def save_model_and_assets(model, tfidf, model_path='xgboost_model.pkl', tfidf_path='tfidf_vectorizer.pkl'):
    """
...
def main():
    """
    Main function to train and evaluate XGBoost on the provided dataset using cross-validation.
    """
    ...
    print("Metrics saved to xgboost_metrics.json")
