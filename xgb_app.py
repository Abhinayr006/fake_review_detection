...
def preprocess_input(stars, useful, funny, cool, user_review_count, user_average_stars,
    ...
    """
    Preprocess input features for XGBoost prediction.
    """
...
def main():
    st.title("🚀 Fake Review Detection - XGBoost Model")
    st.markdown("---")

    # Load model and metrics
    model = load_xgb_model()
    metrics = load_xgb_metrics()
    ...
    # Footer
    st.markdown("---")
    st.markdown("*XGBoost model trained on 5,638 samples with 14 behavioral features*")
